...
int resolve_dot(TypeEnv* env, AST* expr, TypeInfo* out);
...
return resolve_dot(env, expr, out);
}
...
int typecheck_check(AST* ast, char* src) {
...
int type_errors = typecheck_check(ast, file);
if (type_errors > 0) {
